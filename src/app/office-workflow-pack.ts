...
const DEPARTMENT_PERSON_NAME_POOL: Partial<Record<string, Localized[]>> = {
  planning: [
    ...
    { ko: "카엘렌", en: "Kaelen", ja: "ケイレン", zh: "凯伦" },
    { ko: "아샤라", en: "Ashara", ja: "アシャラ", zh: "阿莎拉" },
    { ko: "보릭", en: "Vorik", ja: "ヴォリック", zh: "沃里克" },
    { ko: "타일라", en: "Tyla", ja: "タイラ", zh: "泰拉" },
    { ko: "마렉", en: "Marek", ja: "マレック", zh: "马雷克" },
    { ko: "라이렌", en: "Lyren", ja: "ライレン", zh: "莱伦" },
  ],
  dev: [
    ...
    { ko: "카엘", en: "Kael", ja: "ケイル", zh: "凯尔" },
    { ko: "자라", en: "Zara", ja: "ザラ", zh: "扎拉" },
    { ko: "렌", en: "Ren", ja: "レン", zh: "任" },
    { ko: "타란", en: "Taran", ja: "タラン", zh: "塔兰" },
    { ko: "소라", en: "Sorra", ja: "ソラ", zh: "索拉" },
    { ko: "잭스", en: "Jax", ja: "ジャックス", zh: "贾克斯" },
  ],
  design: [
    ...
    { ko: "닉스", en: "Nyx", ja: "ニクス", zh: "尼克斯" },
    { ko: "엘라라", en: "Elara", ja: "エララ", zh: "艾拉拉" },
    { ko: "오린", en: "Orin", ja: "オリン", zh: "奥林" },
    { ko: "세이블", en: "Sable", ja: "セーブル", zh: "赛布尔" },
    { ko: "벡스", en: "Vex", ja: "ヴェクス", zh: "维克斯" },
    { ko: "테라", en: "Thera", ja: "テラ", zh: "塞拉" },
  ],
  qa: [
    ...
    { ko: "덱스", en: "Dex", ja: "デクス", zh: "德克斯" },
    { ko: "미라J", en: "Mira", ja: "ミラ", zh: "米拉" },
    { ko: "코르", en: "Corr", ja: "コール", zh: "科尔" },
    { ko: "라야", en: "Raya", ja: "ラヤ", zh: "拉雅" },
    { ko: "브렌", en: "Bren", ja: "ブレン", zh: "布伦" },
    { ko: "수리", en: "Suri", ja: "スリ", zh: "苏里" },
  ],
  operations: [
    ...
    { ko: "렉스", en: "Rex", ja: "レックス", zh: "雷克斯" },
    { ko: "노바", en: "Nova", ja: "ノヴァ", zh: "诺瓦" },
    { ko: "케이드", en: "Cade", ja: "ケイド", zh: "凯德" },
    { ko: "리라", en: "Lira", ja: "リラ", zh: "莉拉" },
    { ko: "토르", en: "Tor", ja: "トール", zh: "托尔" },
    { ko: "아샤", en: "Asha", ja: "アシャ", zh: "阿莎" },
  ],
  devsecops: [
    ...
    { ko: "비질", en: "Vigil", ja: "ヴィジル", zh: "警戒" },
    { ko: "셰이드", en: "Shade", ja: "シェイド", zh: "影卫" },
    { ko: "가드", en: "Guard", ja: "ガード", zh: "守卫" },
    { ko: "워든", en: "Warden", ja: "ウォーデン", zh: "典狱" },
    { ko: "바스천", en: "Bastion", ja: "バスティオン", zh: "堡垒" },
    { ko: "센티넬", en: "Sentinel", ja: "センチネル", zh: "哨兵" },
  ],
};
...
const PACK_SEED_PROFILE: Partial<Record<WorkflowPackKey, SeedProfile>> = {
  ...
  jedi: {
    nameOffset: 6,
    tone: {
      ko: "포스의 균형과 임무 완수를 최우선으로 판단합니다.",
      en: "Prioritizes balance of the Force and mission accomplishment.",
      ja: "フォースの均衡と任務達成を最優先とします。",
      zh: "以原力平衡与任务达成为最高优先级。",
    },
  },
};
...
const PACK_PRESETS: Record<WorkflowPackKey, PackPreset> = {
  ...
  jedi: {
    ...
    summary: {
      ko: "제다이 평의회 지휘 구조",
      en: "Jedi Council command structure",
      ja: "ジェダイ評議会の指揮構造",
      zh: "绝地委员会指挥结构",
    },
    roomThemes: {
    ...
    departments: {
      planning: {
        name: { ko: "제다이 아카이브", en: "Jedi Archives", ja: "ジェダイ・アーカイブ", zh: "绝地档案馆" },
        icon: "📜",
        agentPrefix: { ko: "기록관", en: "Archivist", ja: "記録官", zh: "档案员" },
        avatarPool: ["📜", "📚", "🧭"],
      },
      dev: {
        name: { ko: "수련장", en: "Training Grounds", ja: "修練場", zh: "训练场" },
        icon: "⚔️",
        agentPrefix: { ko: "제다이 기사", en: "Jedi Knight", ja: "ジェダイ・ナイト", zh: "绝地武士" },
        avatarPool: ["⚔️", "🗡️", "🛡️"],
      },
      design: {
        name: { ko: "홀로크론 보관소", en: "Holocron Vault", ja: "ホロクロン保管庫", zh: "全息仪保险库" },
        icon: "🔮",
        agentPrefix: { ko: "홀로크론 관리자", en: "Holocron Keeper", ja: "ホロクロン管理者", zh: "全息仪保管员" },
        avatarPool: ["🔮", "✨", "💎"],
      },
      qa: {
        name: { ko: "심판의 간", en: "Trial Chamber", ja: "審査の間", zh: "审判厅" },
        icon: "⚖️",
        agentPrefix: { ko: "제다이 파수꾼", en: "Jedi Sentinel", ja: "ジェダイ・センチネル", zh: "绝地哨兵" },
        avatarPool: ["⚖️", "🛡️", "👁️"],
      },
    },
    staff: {
      nonLeaderDeptCycle: ["planning", "dev", "qa", "dev", "planning", "design", "operations", "dev"],
    },
  },
};
